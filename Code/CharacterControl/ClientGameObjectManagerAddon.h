...
struct ClientGameObjectManagerAddon : public GameObjectManagerAddon
{
	...
	PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_CreateVampireNPC);
	virtual void do_CreateVampireNPC(PE::Events::Event *pEvt);
	...
	void createVampireNPC(Events::Event_CreateVampireNPC* pTrueEvent);
