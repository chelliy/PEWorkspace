...
namespace CharacterControl {
	...
	namespace Components {
		...
		PE_IMPLEMENT_CLASS1(VampireNPCAnimationSM, DefaultAnimationSM);

		VampireNPCAnimationSM::VampireNPCAnimationSM(PE::GameContext& context, PE::MemoryArena arena, PE::Handle hMyself) : DefaultAnimationSM(context, arena, hMyself)
		{
			m_curId = TEMP;
		}

		void VampireNPCAnimationSM::addDefaultComponents()
		{
