#ifndef _PE_VAMPIRE_NPC_ANIMATION_SM_H_
#define _PE_VAMPIRE_NPC_ANIMATION_SM_H_
...
namespace CharacterControl {
	...
	namespace Components {
		...
		struct VampireNPCAnimationSM : public PE::Components::DefaultAnimationSM
		{
			PE_DECLARE_CLASS(VampireNPCAnimationSM);
			...
			VampireNPCAnimationSM(PE::GameContext& context, PE::MemoryArena arena, PE::Handle hMyself);
