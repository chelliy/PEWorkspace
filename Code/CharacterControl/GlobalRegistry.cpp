...
#include "Characters/VampireNPC.h"
#include "Characters/VampireNPCAnimationSM.h"
//#include "Characters/SoldierNPCMovementSM.h"
//#include "Characters/SoldierNPCBehaviorSM.h"
	...
	// start root
	{
		...
		// start root.CharacterControl
		{
			...
			// start root.CharacterControl.Components
			{
				...
				VampireNPC::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				VampireNPCAnimationSM::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				//SoldierNPCMovementSM::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				//SoldierNPCBehaviorSM::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
			...
			{
				Event_CreateVampireNPC::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				...
				SoldierNPCAnimSM_Event_TAKECOVER::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				SoldierNPCAnimSM_Event_JUMPCOVER::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				SoldierNPCAnimSM_Event_FLOATING::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				SoldierNPCAnimSM_Event_LANDING::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				SoldierNPCAnimSM_Event_HIGHCOVER::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				SoldierNPCAnimSM_Event_LOWCOVER::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				...
				SoldierNPCMovementSM_Event_TAKE_COVER::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
