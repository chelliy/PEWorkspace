...
struct DebugRenderer : public SceneNode
{
	...
	void createAABBMesh(Mesh* mesh, Matrix4x4 worldTransfrom, float timeToLive, float scale = 1.0f);
	void createALine(Vector3 start, Vector3 end, float timeToLive, Vector3 color, float scale = 1.0f);
