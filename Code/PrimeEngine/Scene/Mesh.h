...
struct Mesh : public Component
{
	...
	void updateAABBWorldPoints(Matrix4x4 worldTransform);
	...
	Vector3 m_AABB_Max = Vector3(-FLT_MAX, -FLT_MAX, -FLT_MAX);
	Vector3 m_AABB_Min = Vector3(FLT_MAX, FLT_MAX, FLT_MAX);
	Vector3 m_world_AABB_Max = Vector3(-FLT_MAX, -FLT_MAX, -FLT_MAX);
	Vector3 m_world_AABB_Min = Vector3(FLT_MAX, FLT_MAX, FLT_MAX);
	Matrix4x4 m_AABB_Debug_Render[4];
	Array<Vector3> m_AABB_Corner_Points;
	Array<Vector3> m_AABB_World_Points;
